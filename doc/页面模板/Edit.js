...
import { SchemaForm, SchemaMarkupField as Field, FormPath, createFormActions } from "@formily/antd";
    ...
    >
      <SchemaForm
        ...
        effects={($, { setFieldState }) => {
          $("onFieldValueChange", "entityType").subscribe(({ value }) => {});
          $("onFieldInputChange", FormPath.match("algorithmConfig.*")).subscribe(({ value }) => {
            setFieldState("algorithmConfig.filter", (state) => {
